...
#' @param users.df Optional dataframe containing at least 2 columns (username, data_access_group) used to evaluate incorrect DAG
...
if(users.df != ""){
  ...
  check.output <- list("forms_na" = forms_na,
                       ...
                       "dag_incorrect" = dag_incorrect)}else{
