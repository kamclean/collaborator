...
data_author <- read_csv("~/collaborator/data_author.csv")
data_author %>%
  select("name" = full_name, "group"=location, country) -> data_author
View(report_auth(data_author, subdivision = "country")
